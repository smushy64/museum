...
global inline const Lane4f negate_first128 = lane4f_set(
    -1.0f,
    1.0f,
    1.0f,
    1.0f
...
quat operator*( quat lhs, quat rhs ) {
    ...
    quat result;
    lane4f_store( value_pointer(result), lane4f_add( w, a ) );
    return result;
}
...
mat4 operator+( const mat4& lhs, const mat4& rhs ) {
    ...
    lhs0 = lane4f_load( value_pointer( lhs.col0 ) );
    lhs1 = lane4f_load( value_pointer( lhs.col1 ) );
    lhs2 = lane4f_load( value_pointer( lhs.col2 ) );
    lhs3 = lane4f_load( value_pointer( lhs.col3 ) );

    rhs0 = lane4f_load( value_pointer( rhs.col0 ) );
    rhs1 = lane4f_load( value_pointer( rhs.col1 ) );
    rhs2 = lane4f_load( value_pointer( rhs.col2 ) );
    rhs3 = lane4f_load( value_pointer( rhs.col3 ) );

    mat4 result;

    lane4f_store( value_pointer(result.col0), lane4f_add( lhs0, rhs0 ) );
    lane4f_store( value_pointer(result.col1), lane4f_add( lhs1, rhs1 ) );
    lane4f_store( value_pointer(result.col2), lane4f_add( lhs2, rhs2 ) );
    lane4f_store( value_pointer(result.col3), lane4f_add( lhs3, rhs3 ) );
...
mat4 operator-( const mat4& lhs, const mat4& rhs ) {
    ...
    lane4f_store( value_pointer(result.col0), lane4f_sub( lhs0, rhs0 ) );
    lane4f_store( value_pointer(result.col1), lane4f_sub( lhs1, rhs1 ) );
    lane4f_store( value_pointer(result.col2), lane4f_sub( lhs2, rhs2 ) );
    lane4f_store( value_pointer(result.col3), lane4f_sub( lhs3, rhs3 ) );
...
mat4 operator*( const mat4& lhs, f32 rhs ) {
    ...
    lane4f_store( value_pointer(result.col0), lane4f_mul( lhs0, rhs_ ) );
    lane4f_store( value_pointer(result.col1), lane4f_mul( lhs1, rhs_ ) );
    lane4f_store( value_pointer(result.col2), lane4f_mul( lhs2, rhs_ ) );
    lane4f_store( value_pointer(result.col3), lane4f_mul( lhs3, rhs_ ) );
...
mat4 operator/( const mat4& lhs, f32 rhs ) {
    ...
    lane4f_store( value_pointer(result.col0), lane4f_div( lhs0, rhs_ ) );
    lane4f_store( value_pointer(result.col1), lane4f_div( lhs1, rhs_ ) );
    lane4f_store( value_pointer(result.col2), lane4f_div( lhs2, rhs_ ) );
    lane4f_store( value_pointer(result.col3), lane4f_div( lhs3, rhs_ ) );
...
mat4 operator*( const mat4& lhs, const mat4& rhs ) {
    ...
    u32 col = 0;
    u32 row = 0;
    a = lane4f_load( &lhs.c[row * MAT4::COLUMN_COUNT] );
    b = lane4f_mul( a, lane4f_set1( rhs.c[(col * MAT4::COLUMN_COUNT) + row] ) );
    c = lane4f_load( &result.c[ col * MAT4::COLUMN_COUNT ] );
    lane4f_store( &result.c[col * MAT4::COLUMN_COUNT], lane4f_add( b, c ) );
