...
#define GL_SHADER_PROGRAM_LOCATION_DIRECTIONAL_SHADOW_MAP_BINDING (10)
#define GL_SHADER_PROGRAM_LOCATION_POINT_SHADOW_MAP_0_BINDING     (11)
#define GL_SHADER_PROGRAM_LOCATION_POINT_SHADOW_MAP_1_BINDING     (12)
#define GL_SHADER_PROGRAM_LOCATION_POINT_SHADOW_MAP_2_BINDING     (13)
#define GL_SHADER_PROGRAM_LOCATION_POINT_SHADOW_MAP_3_BINDING     (14)
...
#define GL_SHADER_PROGRAM_PHONG_BRDF_TINT_INDEX                (2)
...
#define GL_SHADER_PROGRAM_PHONG_BRDF_METALLIC_TEXTURE_BINDING  (3)
